...
# ghcr.io/mountaintopsolutions/apt-cacher-ng:v3.7.4-20260810
...
```bash
docker pull ghcr.io/mountaintopsolutions/apt-cacher-ng:v3.7.4-20260810
```
...
docker run --name apt-cacher-ng --init -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  ghcr.io/mountaintopsolutions/apt-cacher-ng:v3.7.4-20260810 -h
```
...
docker run --name apt-cacher-ng --init -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  ghcr.io/mountaintopsolutions/apt-cacher-ng:v3.7.4-20260810 -e
```
